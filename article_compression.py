...
def filter_text_length(input_file, output_file):
    ...
    filtered_df = df[(df['honbun'].str.len() > 299) & (df['honbun'].str.len() < 601)]
...
strings_to_remove = ['［青嵐俳談］', '［きょうの救急病院］', '［お悔やみ］', '［天気］','［天気予報］','［愛媛柳壇］','［地域俳歌柳壇］','［ギャラリーガイド］',
                     '［えひめ防犯情報］','［愛媛詩壇］','［月間のこよみ］','［釣りだより］','［女性俳壇］','［愛媛歌壇］','［愛媛俳壇］',
                     '［先週のベストセラー］','［愛媛新聞事業ガイド］','［集まれ俳句キッズ］','［ヒーロー☆ミュージアム］',
                     '［親子で作ろう　Ｃｏｏｋｉｎｇ　ｏｎ　Ｓｕｎｄａｙ］','［当番医］','［食べて健やか　愛媛県栄養士会］','［短歌］','［川柳］',
                     '俳句','［あの町この街］','［私募債］','［読者の写真］','［人事］','［愛媛新聞事業ガイド］','［愛媛新聞あすの催し］','［社告］','［ムシペディア］',
                     '［ピント！ラボ］','［突撃！！インタビュー］','［ピントの豆知識］','［週間の動き］','県内相談窓口','［えひめっこピカイチコンテスト］','［?スタ（愛媛新聞ｆｏｒスタディ）　ニュース学習帳］',
                     '俳談','美術展','社内表彰','［イベント情報］','［情報バスケット］','棋士勝敗','「読者と報道」','［珍種ハンター　ウネリン先生］','［県感染症情報］','当選者','愛媛県関係の受章者','愛媛県関係受章者',
                     '立候補者','従事者叙勲','私の好きな詩','［えひめくらし安全ナビ　県消費生活センター］','［お知らせ］','県品評会','教職員異動','人事異動','桜だより','世論調査',
                     '文学賞','新聞グランプリ','叙勲','票結果'] 
